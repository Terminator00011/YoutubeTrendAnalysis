...
public class Map {
    ...
    public void inOrder()
    {
        this.root = helperInOrder(this.root);
        System.out.println();
    }

    private Node helperInOrder(Node curr)
    {
        if (curr == null)
            return null;

        curr.left = helperInOrder(curr.left);
        System.out.print(curr.getVideoID() + ", ");
        curr.right = helperInOrder(curr.right);
